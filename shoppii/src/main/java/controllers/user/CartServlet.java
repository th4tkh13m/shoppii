...
public class CartServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Type type = new TypeToken<HashMap<Shop, HashMap<Product, Integer>>>() {
        }.getType();
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            HashMap<Shop, HashMap<Product, Integer>> cart = CartDAO.addProductToCart(userId, productId, quantity,
                    connection);
            String json = gson.toJson(cart, type);
            resp.setStatus(201);
            resp.getOutputStream().write(json.getBytes("UTF-8"));
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            HashMap<Shop, HashMap<Product, Integer>> cart = CartDAO.modifyProductQuantity(userId, productId, quantity,
                    connection);
            String json = gson.toJson(cart, type);
            resp.setStatus(200);
            resp.getOutputStream().write(json.getBytes("UTF-8"));
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            HashMap<Shop, HashMap<Product, Integer>> cart = CartDAO.deleteProductFromCart(userId, productId,
                    connection);
            String json = gson.toJson(cart, type);
            resp.setStatus(200);
            resp.getOutputStream().write(json.getBytes("UTF-8"));
