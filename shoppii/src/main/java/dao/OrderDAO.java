...
public class OrderDAO {
    ...
    public static ArrayList<Order> getOrdersOfUser(int userId, String status, Connection connection) throws SQLException {
    ...
    public static HashMap<Order, HashMap<Product, Integer>> getOrderWithItemsofUser(int userId, String status, Connection connection) throws SQLException {
    ...
    public static HashMap<Order, HashMap<Product, Integer>> getOrderWithItemsofShop(int shopId, String status, Connection connection) throws SQLException {
